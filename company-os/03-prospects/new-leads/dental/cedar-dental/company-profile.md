...
| **Primary location** | 4201 1st Ave SE, Cedar Rapids, IA |
| **Phone** | (319) 364-7108 |
| **Website** | https://cedar-dental.com/ |
| **Stage** | `new-leads` (not contacted) |

## Angle for outreach

Cosmetic focus; consult tracking.
...
- Move when qualified: `../../qualified/cedar-dental/` (copy folder)
