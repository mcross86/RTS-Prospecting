...
| **Website** | https://www.springvalleydentalcare.com/ |
| **Stage** | `new-leads` (not contacted) |

## Angle for outreach

Restorative + pediatrics + aligners.
...
- Industry playbook: `../../../02-industries/dental/`
- Move when qualified: `../../qualified/spring-valley-dental-care/` (copy folder)
