...
| Field | Value |
|-------|--------|
| **Industry vertical** | `home-cleaning` |
| **Primary location** | Cedar Rapids / IC corridor |
| **Phone** | — verify on website or Google Maps |
| **Website** | https://cleanhomesiowa.com/ |
| **Stage** | `new-leads` (not contacted) |

## Angle for outreach

Family-owned; 15+ yrs messaging on site.
...
- Industry playbook: `../../../02-industries/home-cleaning/`
- Move when qualified: `../../qualified/cleanhomes-iowa/` (copy folder)
