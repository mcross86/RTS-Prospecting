...
| Field | Value |
|-------|--------|
| **Industry vertical** | `hvac` |
| **Primary location** | Eastern Iowa (verify) |
| **Phone** | — verify on website or Google Maps |
| **Website** | https://linsheatingandair.com/ |
| **Stage** | `new-leads` (not contacted) |

## Angle for outreach

Regional HVAC; financing messaging on site.
...
- Industry playbook: `../../../02-industries/hvac/`
- Move when qualified: `../../qualified/lins-heating-and-air-conditioning/` (copy folder)
