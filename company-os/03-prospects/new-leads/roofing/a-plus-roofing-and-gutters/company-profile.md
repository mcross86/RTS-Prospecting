...
| Field | Value |
|-------|--------|
| **Industry vertical** | `roofing` |
| **Primary location** | Cedar Rapids, IA metro |
| **Phone** | — verify on website or Google Maps |
| **Website** | https://aplusroofinggutters.com/ |
| **Stage** | `new-leads` (not contacted) |

## Angle for outreach

Storm + financing messaging.
...
- Industry playbook: `../../../02-industries/roofing/`
- Move when qualified: `../../qualified/a-plus-roofing-and-gutters/` (copy folder)
